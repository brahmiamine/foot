...
/**
 * POST /api/admin/arbitrage/arbinote/alerts/[id]/resolve
...
export async function POST(
  ...
  try {
    ...
    // /api/admin/arbitrage/arbinote/alerts/[id]/history) — audit_logs reste la seule source de
    ...
    console.error('Unexpected error in /api/admin/arbitrage/arbinote/alerts/[id]/resolve:', error)
    return NextResponse.json(
