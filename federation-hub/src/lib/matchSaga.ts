 ...
 * la saga ne fait que compenser côté ticketing/club-hub ensuite et
 * consigner le résultat. Chaque étape (fermeture vente + remboursement
 * ticketing, annulation convocations club-hub) est tentée une fois
 ...
 * (ticketing/club-hub lisent `matches.status` directement, ce
 ...
 * n'est jamais réappelée (ticketing/club-hub sont idempotents de
