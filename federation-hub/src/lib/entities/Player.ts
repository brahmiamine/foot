...
/**
 * Mappée sur `Player` (table `club-hub`, référentiel effectif club) —
 * lecture seule ici (`club-hub` reste seul propriétaire, voir
 ...
 * présentes côté `club-hub`, simplement absentes de ce mapping partiel).
 */
@Entity('Player')
export class Player {
