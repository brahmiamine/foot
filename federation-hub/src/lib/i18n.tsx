...
export function TranslationProvider({
  ...
  const switchLocale = (newLocale: Locale) => {
    ...
    if (typeof window !== 'undefined') {
      localStorage.setItem('federation-hub-locale', nextLocale)
      document.cookie = `federation-hub_locale=${nextLocale}; path=/; max-age=31536000; samesite=lax`
    }
  }
  ...
  useEffect(() => {
    ...
    localStorage.setItem('federation-hub-locale', sanitizedInitialLocale)
