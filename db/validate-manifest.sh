...
EXCLUDED_COPIES=(
  "referee-center/migrations/add_is_active_to_federations.sql"
  "referee-center/migrations/add_is_active_to_leagues.sql"
  "referee-center/migrations/add_unique_vote_per_match_device.sql"
  "referee-center/migrations/add_team_branding.sql"
  "referee-center/migrations/add_team_branding_icons.sql"
  "referee-center/mysql/migration_add_audit_logs.sql"
  "referee-center/mysql/migration_add_ip_address_to_votes.sql"
  "referee-center/mysql/migration_add_team_fields.sql"
  "referee-center/mysql/migration_add_team_gender_and_youth_categories.sql"
  "referee-center/mysql/migration_add_tournois_type.sql"
  "referee-center/mysql/migration_add_vote_alerts.sql"
  "referee-center/mysql/migration_add_vote_moderation.sql"
  "referee-center/mysql/migration_add_staff_invitations.sql"
  "referee-center/mysql/migration_add_match_actual_times.sql"
  "match-operations/sql/migration_add_card_unique_constraint.sql"
  "club-hub/sql/migration_add_team_gender_and_youth_categories.sql"
)
