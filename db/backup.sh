...
# et des dossiers d'uploads applicatifs (arbinote/federation-hub/club-hub) —
...
UPLOAD_DIRS=(arbinote/public/uploads federation-hub/public/uploads club-hub/public/uploads)
