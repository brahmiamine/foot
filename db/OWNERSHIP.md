...
| Transferts de joueurs | `player_transfers` | `superadmin` (`/admin/players`) | `teamManager` (lecture, historique du club — `/admin/players/transfers`) ; `ob` (lecture, section publique « Derniers transferts ») |
