...
/**
 * TS-14 (avancement.md) : le même eventId de webhook payment-api peut
 * arriver plusieurs fois (retries) — claimWebhookEvent() ne doit laisser
 * traiter le premier appel qu'une seule fois.
 */
