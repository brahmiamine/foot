...
/**
 * Mappée sur `matches`, table partagée avec ArbiNote/superadmin/teamManager
 * (mêmes UUID). Lecture seule ici, filtrée par `isPublicVisible` : la
 * création/édition d'un match reste dans superadmin/teamManager. C'est
 * l'« event » de la billetterie — pas de table dupliquée (voir README
