 ...
 * CANCELLED (superadmin, `cancelMatchAdmin`) — même modèle que
 * `StockUnavailableRefund` (TASK-P0-002), même limites côté payment-api
 * (Konnect/Paymee et tout remboursement partiel passent par MANUAL_REVIEW,
 * voir payment-api/README.md § Remboursements). Un seul dossier par
