 ...
 * dupliqué ici) et le remboursement (refund_id chez payment-api, voir
...
export class StockUnavailableRefund {
  ...
  // automatique ou après résolution opérateur côté payment-api) — jamais
  // pour MANUAL_REVIEW, qui reste un dossier ouvert tant qu'un opérateur ne
  // l'a pas tranché (voir payment-api POST /refunds/:id/{confirm,reject}).
