...
Huit applications importent directement ce module : `arbinote`, `match-operations`,
`referee-hub`, `player-hub`, `federation-hub`, `club-hub`, `ob` et `ticketing`. Leurs wrappers
