  ...
  describe('buildKonnectInitPaymentRequest', () => {
    it('whitelists only the expected fields and never leaks unrelated data', () => {
      ...
      expect(request).toEqual({
        ...
        email: 'amine@example.com',
        phoneNumber: '20000000',
        webhook: 'https://payments.example.com/payments/konnect/webhook',
        successUrl:
          'https://payments.example.com/payment/success?paymentId=payment-uuid-1',
        failUrl:
          'https://payments.example.com/payment/fail?paymentId=payment-uuid-1',
