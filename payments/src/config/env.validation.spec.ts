...
describe('validateEnv', () => {
  function validEnv(overrides: Record<string, string> = {}): Record<string, string> {
    return {
      ...
      PAYMEE_WEBHOOK_URL: 'https://api.example.com/payments/providers/paymee/webhook',
      ...
      FLOUCI_WEBHOOK_URL: 'https://api.example.com/payments/providers/flouci/webhook',
  ...
  it('rejects a previous key without an expiry', () => {
    expect(() =>
      validateEnv(validEnv({ SERVICE_API_KEYS_PREVIOUS: '{"club-ob":"ob-old-key"}' })),
