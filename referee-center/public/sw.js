...
// Réception des notifications Web Push (alertes de vote, anomalies —
// voir avancement.md, "Web Push généralisé"). Même format que ob/public/sw.js.
self.addEventListener('push', (event) => {
  ...
  const { title = 'ArbiNote', body, url = '/admin/alerts', icon = '/logo-light.png' } = payload;
  event.waitUntil(
...
self.addEventListener('notificationclick', (event) => {
  ...
  const targetUrl = event.notification.data?.url ?? '/admin/alerts';
  event.waitUntil(
