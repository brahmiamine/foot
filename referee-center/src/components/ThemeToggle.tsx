...
function readStoredTheme(): "light" | "dark" {
  ...
  return localStorage.getItem("referee-center-theme") === "dark" ? "dark" : "light";
}
...
export default function ThemeToggle() {
  ...
  useEffect(() => {
    ...
    if (theme === "dark") {
      localStorage.setItem("referee-center-theme", "dark");
      html.classList.add("dark");
    } else {
      localStorage.setItem("referee-center-theme", "light");
