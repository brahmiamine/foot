...
const DEVICE_ID_KEY = "referee-center_push_device_id";
 ...
 * fin vers notifications, voir src/lib/notificationApi.ts) plutôt que
 * des Server Actions — convention non utilisée ailleurs dans referee-center.
 */
