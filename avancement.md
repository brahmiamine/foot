...
| `billetterie` | Audience réservée auto-déclarée ; scanner stade absent ; pas de tâche planifiée de purge des réservations `PENDING` ; pas de tests | Prioriser contrôle d'accès et preuve d'audience avant vente réelle sensible ; ajouter tests et éventuellement cron de nettoyage |
