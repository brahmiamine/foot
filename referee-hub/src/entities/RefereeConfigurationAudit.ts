...
export type RefereeConfigurationSnapshot = Record<string, unknown>;

/** GOV-005 — journal append-only des changements de configuration referee-hub. */
@Entity("referee_configuration_audit")
export class RefereeConfigurationAudit {
  ...
  before!: RefereeConfigurationSnapshot | null;

  @Column({ type: "json", name: "after_value" })
  after!: RefereeConfigurationSnapshot;
