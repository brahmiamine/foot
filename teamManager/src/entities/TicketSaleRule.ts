 ...
 * table `tk_ticket_sale_rules`, partagée avec `billetterie`. Une seule
 * règle par `matchTicketCategoryId` dans cette admin (voir TicketingService,
 * upsert plutôt qu'un CRUD à plusieurs règles) : `billetterie` ne lit que
 * la première trouvée.
 *
 ...
 * billetterie/src/entities/TicketSaleRule.ts. Ne pas construire de logique
