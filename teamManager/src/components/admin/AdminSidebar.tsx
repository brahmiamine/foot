    ...
    () => [
      ...
      },
      {
        ...
        items: [
          ...
          { title: "Documents & échéances", icon: "fas fa-folder-open", href: "/admin/documents", children: [], permission: "documents.view" },
          { title: "Cotisations & paiements", icon: "fas fa-coins", href: "/admin/finance", children: [], permission: "finance.view" },
      ...
      },
      {
        ...
        items: [
          ...
          { title: "Commandes boutique", icon: "fas fa-receipt", href: "/admin/orders", children: [], permission: "orders.view" },
          ...
          { title: "Évaluations joueurs", icon: "fas fa-star", href: "/admin/evaluations", children: [], permission: "evaluations.view" },
        ],
      },
      {
