      ...
      },
      {
        ...
        items: [
          ...
          { title: "Sponsors", icon: "fas fa-handshake", href: "/admin/sponsors", children: [], permission: "sponsors.view" },
          {
            ...
            children: [
              { title: "Billetteries", href: "/admin/ticketing" },
              { title: "Catégories", href: "/admin/ticketing/categories" },
              { title: "Commandes", href: "/admin/ticketing/orders" },
              { title: "Billets", href: "/admin/ticketing/tickets" },
              { title: "Statistiques", href: "/admin/ticketing/stats" },
              { title: "Contrôleurs", href: "/admin/ticketing/controllers" },
            ],
          },
          { title: "Scanner billets", icon: "fas fa-qrcode", href: "/admin/ticketing/scanner", children: [], permission: "ticketing.scan" },
