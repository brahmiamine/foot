...
/**
 * Bannière d'installation PWA — même logique qu'arbinote (détection mobile,
 * beforeinstallprompt Android/Chrome, instructions manuelles iOS), mais
 * stylée en Bootstrap pour rester cohérente avec le reste de l'app (voir
 * AdminHeader.tsx).
 */
  ...
  return (
    ...
    >
      <div className="d-flex align-items-center gap-2 flex-grow-1 min-w-0">
        <Image src="/icon-192x192.png" alt="Footclub" width={40} height={40} style={{ borderRadius: 8 }} />
        <div className="flex-grow-1 min-w-0">
          <p className="mb-0 small fw-semibold text-truncate">Installer Footclub</p>
