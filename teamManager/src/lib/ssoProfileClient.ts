...
/**
 * Client serveur-à-serveur vers sso : GET /api/members/me/profile — même
 * client que billetterie/src/lib/ssoProfileClient.ts (voir ce fichier).
 * N'existe que pour Paymee, qui exige firstName/lastName/phoneNumber à
