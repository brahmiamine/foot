...
// billetterie/src/lib/stockUnavailableRefunds.ts.
 ...
 * la demande de remboursement auprès de payment-api. Ne lève jamais : un
 * payment-api indisponible laisse le dossier à PENDING_REFUND_REQUEST,
