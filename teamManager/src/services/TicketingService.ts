...
/**
 * Administration de la billetterie d'un club (tables `tk_*`, partagées en
 * écriture avec `billetterie` — voir entities/TicketCategory.ts). Toujours
...
export class TicketingService {
  ...
  // billetterie d'un match (voir README racine § « Billetterie »).
