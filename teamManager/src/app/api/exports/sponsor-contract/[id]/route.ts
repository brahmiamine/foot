 ...
 * administratif des termes déjà saisis dans teamManager, à faire valider
 * par le club avant signature — voir teamManager/README.md.
 */
...
export async function GET(request: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  ...
  doc.text(
    "Document généré automatiquement à partir des informations saisies dans teamManager — résumé administratif,",
    14,
    finalY + 12,
  );
