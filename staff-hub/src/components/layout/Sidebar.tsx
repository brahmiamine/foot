  ...
  return (
    ...
    >
      <div style={{ display: "flex", alignItems: "center", gap: 10, padding: "0 0.4rem 1.5rem" }}>
        ...
        <div>
          <div style={{ fontSize: "0.85rem", fontWeight: 700, color: "#fff" }}>Espace Staff</div>
          ...
          return (
            <Link
              ...
              style={{
                ...
                color: active ? "var(--sh-sidebar-text-active)" : "var(--sh-sidebar-text)",
                background: active ? "var(--sh-sidebar-active-bg)" : "transparent",
                marginBottom: 2,
              }}
            >
