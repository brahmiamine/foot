...
const shell = createShellClassNames("sh");
const responsiveCss = createResponsiveShellCss("sh");
...
export function AppShell({
  ...
  const brandingVars = createBrandingVariables("sh", clubBranding) as CSSProperties;
