...
/**
 * ClubBranding résolu dynamiquement à partir du teamId du joueur connecté —
 * jamais hardcodé à un club en particulier (voir README racine, section
 * « Classification des projets »). Mêmes valeurs par défaut que le thème
 * actuel de player-hub (globals.css) tant qu'un club n'a pas configuré son
 * propre branding — voir seller-portal/src/lib/clubBranding.ts (même pattern).
 */
