...
/**
 * Copie en lecture seule de `team_branding` (gérée dans federation-hub, voir
 * TeamBrandingPanel). seller-portal ne fait que résoudre le branding du club
 * du vendeur connecté (Seller.clubId) — jamais de logique spécifique à un
 * club hardcodée ici.
 */
