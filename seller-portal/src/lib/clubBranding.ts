 ...
 * Les valeurs par défaut ci-dessous reprennent le thème FOOT partagé afin que
 * le rendu serveur et le thème CSS restent cohérents tant qu'un club n'a pas
 * configuré son propre branding.
 */
