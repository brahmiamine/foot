...
// le compte est créé PENDING, l'OB doit valider depuis teamManager avant
// que le vendeur puisse réellement vendre (voir src/lib/authz.ts).
export async function POST(req: NextRequest) {
  try {
    ...
    return NextResponse.json(
      {
        message: "Inscription reçue. Votre compte est en attente de validation par l'Olympique de Béja.",
        sellerId: result.id,
