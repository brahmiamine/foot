...
export default function RegisterPage() {
    ...
    return (
      <div style={{ textAlign: "center" }}>
        ...
        <p style={{ color: "var(--sp-text-muted)", fontSize: "0.88rem", lineHeight: 1.5 }}>
          Votre compte est en attente de validation par l&rsquo;Olympique de Béja. Vous recevrez un accès complet dès
  ...
  return (
    <form onSubmit={handleSubmit}>
      <h2 style={{ margin: "0 0 0.35rem", fontSize: "1.05rem" }}>Devenir vendeur sur la marketplace OB</h2>
      <p style={{ margin: "0 0 1.25rem", fontSize: "0.8rem", color: "var(--sp-text-muted)" }}>
        Votre demande sera examinée par l&rsquo;Olympique de Béja avant activation.
      </p>
