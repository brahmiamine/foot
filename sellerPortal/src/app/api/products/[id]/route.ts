...
// sémantique différente d'une mise à jour de contenu — voir marketplace-api
...
// l'administration du club — même règle appliquée côté marketplace-api
...
// Les champs du produit sont mis à jour via marketplace-api (voir
// src/lib/marketplaceApiClient.ts, TS-04) ; seules les images restent
// gérées en TypeORM direct côté sellerPortal.
...
// Suppression logique uniquement (voir marketplace-api ProductsService.remove)
