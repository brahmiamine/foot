...
-- payment-api. Additive, n'affecte aucune donnée existante.
...
-- NotificationType (marketplace-api/src/notifications/enums/notification-type.enum.ts) :
...
-- synchronize étant désactivé — voir marketplace-api/src/config/database.config.ts),
