...
Pas de back-office graphique. Script de seed superadmin et endpoints internes d'introspection/annuaire des équipes.
...
Google OAuth et SMTP; cookie/secret/issuer partagés avec les consommateurs SSO. Le script racine le lance sur 3004 uniquement si `sso/.env.local` existe.
