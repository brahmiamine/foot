 ...
 * créer/désactiver/réactiver un compte staff (aujourd'hui : `superadmin`,
 * voir src/lib/identityClient.ts côté superadmin) passent par ces
...
/** Seul endroit qui hache un mot de passe pour un compte créé par une autre app (ex: acceptation d'invitation côté superadmin). */
 ...
 * sso/src/lib/session.ts) — même principe que resetPassword/changePassword
