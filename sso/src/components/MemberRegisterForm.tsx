...
export default function MemberRegisterForm({ redirectTo }: { redirectTo: string }) {
  ...
  return (
    <form onSubmit={handleSubmit} className="sso-form">
      ...
      <Link href={`/membre/login?redirect=${encodeURIComponent(redirectTo)}`} className="sso-switch">
