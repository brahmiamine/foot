-- `Card` a deux écrivains (club-hub et match-operations, voir
...
--
-- Cette migration doit être appliquée identiquement côté match-operations (voir
-- match-operations/sql/migration_add_card_unique_constraint.sql, même fichier) —
