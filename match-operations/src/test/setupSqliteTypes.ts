 ...
 * pattern que referee-center/src/test/setupSqliteTypes.ts et
 * ticketing/src/test/setupSqliteTypes.ts.
 */
vi.mock("typeorm", async (importOriginal) => {
  ...
  // Certains services (voir tickets.ts côté ticketing) prennent un verrou
