 ...
 * même requête (retry réseau après un timeout côté federation-hub, voir
 * federation-hub/src/lib/matchOperationsClient.ts#reopenSheet). `idempotencyKey` est
 * fourni par l'appelant (federation-hub génère une clé une fois par action
