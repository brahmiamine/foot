...
Cet inventaire couvre `src/app/admin` et `src/components/admin`. L’ordre commence par les parcours les plus utilisés. Le contrôle détaillé se lance avec `npm run i18n:check -- --project club-hub --literals` depuis la racine du dépôt.
...
- `src/app/admin/ticketing/categories/CategoriesManagement.tsx`
- `src/app/admin/ticketing/categories/actions.ts`
- `src/app/admin/ticketing/categories/page.tsx`
- `src/app/admin/ticketing/matches/MatchesTicketingList.tsx`
- `src/app/admin/ticketing/matches/[matchId]/MatchOffersManagement.tsx`
- `src/app/admin/ticketing/matches/[matchId]/actions.ts`
- `src/app/admin/ticketing/matches/[matchId]/page.tsx`
- `src/app/admin/ticketing/matches/page.tsx`
