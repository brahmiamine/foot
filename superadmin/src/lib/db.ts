...
function createDataSource() {
  ...
  return new DataSource({
    ...
    synchronize: false,
    entities: [Arbitre, AuditLog, Card, CardReason, CritereDefinitionEntity, Contact, Federation, Goal, Injury, League, Journee, Match, Player, PlayerTransfer, Saison, Sheet, StaffInvitation, Substitution, Team, TeamBranding, User, Vote, VoteAlert],
    extra: {
      decimalNumbers: true,
    },
  })
