...
function createDataSource() {
  ...
  return new DataSource({
    ...
    synchronize: false,
    entities: [Arbitre, AuditLog, CardReason, CritereDefinitionEntity, Contact, Federation, League, Journee, Match, Saison, Team, TeamManagerAuditLog, User, Vote, VoteAlert],
    extra: {
      decimalNumbers: true,
    },
  })
