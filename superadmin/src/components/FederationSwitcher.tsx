...
export default function FederationSwitcher({ variant = 'light' }: Props) {
  ...
  const buttonClasses = isDark
    ...
    : isAdmin
      ? 'btn btn-sm btn-light border d-inline-flex align-items-center gap-2 px-3 py-2 text-body'
  ...
  const dropdownClasses = isDark
    ...
    : isAdmin
      ? 'absolute right-0 z-[70] mt-2 w-80 sm:w-96 rounded border border-light-subtle bg-white text-gray-900 shadow-lg max-h-[80vh] overflow-y-auto'
