...
export class SellersController {
  ...
  /** Liste des vendeurs du club — réservé aux applications internes (club-hub). */
  @Get()
   ...
   * fermer). TASK-P0-027 : restreint explicitement à club-hub/
   * federation-hub — un vendeur ne doit jamais pouvoir s'auto-approuver/
   * s'auto-réactiver, même si seller-portal possède sa propre clé de
