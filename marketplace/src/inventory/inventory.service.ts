...
// Alignée sur le TTL de réservation panier de ticketing/club-hub
...
export class InventoryService {
   ...
   * l'achat de billet (ticketing/src/lib/tickets.ts, purchaseTickets).
   *
   ...
   * payments). Idempotente : confirmer une réservation déjà CONFIRMED
   ...
   * TASK-P0-002/todo.md pour l'équivalent ticketing/club-hub), jamais
