...
export class MarketOrder {
  ...
  // dans payments, scopé par callerApplication).
  ...
  // Payment.id de payments couvrant toute la commande (un seul paiement
  // pour tous les vendeurs impliqués, voir CheckoutService.checkout) — même
  // convention que ticketing/club-hub. Null tant que l'initiation du
