...
export class ReturnRequest {
  ...
  // Refund.id de payments (TASK-P0-001) une fois la demande de
  // remboursement acceptée par payments — jamais renseigné tant que
  // l'appel n'a pas abouti (voir refundError pour l'échec de l'appel
  // lui-même).
  @Column({ type: 'varchar', length: 36, nullable: true })
  refundId: string | null;

  // Dernier statut connu du remboursement chez payments (REQUESTED,
  ...
  // Motif du dernier échec — soit un refus applicatif de payments, soit
