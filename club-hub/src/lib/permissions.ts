/**
 * Catalogue des permissions applicatives de club-hub. Chaque rôle
...
export const PERMISSION_MODULES: PermissionModule[] = [
  ...
  },
  {
    ...
    label: "Billetterie",
    permissions: [
      { key: "ticketing.view", label: "Voir la ticketing" },
      { key: "ticketing.manage", label: "Gérer catégories / vente de billets" },
    ],
  },
  {
    key: "sponsors",
