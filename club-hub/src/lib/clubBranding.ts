 ...
 * dans federation-hub) ; favicon/couleurs/police viennent de `team_branding`
 * (optionnelle, voir federation-hub/TeamBrandingPanel). Les valeurs par défaut
