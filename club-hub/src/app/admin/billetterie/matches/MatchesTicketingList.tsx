  ...
  return (
    <div className="container-fluid px-0">
      <div className="d-flex justify-content-between align-items-center mb-4 gap-2">
        ...
        <Link href="/admin/ticketing/categories" className="btn btn-outline-secondary">
                  ...
                  {matches.map((match) => (
                    <tr key={match.id}>
                      ...
                      <td className="text-end">
                        <Link href={`/admin/ticketing/matches/${match.id}`} className="btn btn-sm btn-outline-primary">
                          <i className="fas fa-ticket me-1" aria-hidden="true" />
                          Configurer la ticketing
                        </Link>
                      </td>
                    </tr>
                  ))}
