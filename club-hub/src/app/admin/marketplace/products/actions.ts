...
/**
 * Appelle marketplace pour la transition demandée (voir
 * src/lib/marketplaceApiClient.ts) — club-hub n'accède plus directement
 * à `sp_products`/`sp_sellers` (voir avancement.md, TS-04). L'audit reste
 * local à club-hub (AuditLog), marketplace n'a pas connaissance des
 * comptes User club-hub.
 */
