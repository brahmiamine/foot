...
import { reopenRejectedPersonLicense } from "@/services/PersonLicenseService";
...
export async function POST(request: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  ...
  try {
    ...
    return NextResponse.json(await reopenRejectedPersonLicense(session.user.teamId, id, {
    ...
    console.error("Error reopening person license:", error);
