 ...
 * uniquement. Appelée par `federation-hub` pour le tableau de bord Transferts
 * — pas de filtre par fédération ici (voir `listTransfers`), `federation-hub`
 ...
 * uniquement (x-api-key, voir lib/serviceAuth.ts). Appelée par `federation-hub`
