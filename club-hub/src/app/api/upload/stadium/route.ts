...
/**
 * POST /api/upload/stadium
 * Upload a stadium image to the uploads directory
 */
export async function POST(request: NextRequest) {
  try {
    ...
    const uploadsDir = join(process.cwd(), "public", "uploads", "stadiums");
    ...
    const publicPath = `/uploads/stadiums/${filename}`;
