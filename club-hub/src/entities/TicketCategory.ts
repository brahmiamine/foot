 ...
 * Table `tk_ticket_categories`, schéma créé dans ticketing/sql/schema.sql
 * (pas dupliqué ici) — partagée avec `ticketing`, qui la lit en lecture
 * seule pour l'achat. club-hub est l'admin : seule cette app écrit dans
 * tk_ticket_categories/tk_match_ticket_categories/tk_ticket_sale_rules,
 * `ticketing` n'écrit que tk_tickets (les billets achetés).
 */
