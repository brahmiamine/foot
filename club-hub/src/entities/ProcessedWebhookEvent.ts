...
/**
 * TASK-P0-005 : journal des `eventId` de webhook payments déjà traités —
 * payments retente la livraison en cas d'échec réseau (voir
 * payments/src/webhooks/webhook-dispatch.service.ts), le même eventId
 ...
 * ticketing/src/entities/ProcessedWebhookEvent.ts.
 */
