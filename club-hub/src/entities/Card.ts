 ...
 *
 * Deux écrivains (club-hub et match-operations, voir db/OWNERSHIP.md) : la
 ...
 * même carton, voir CardService.create (club-hub) et
 * CardEventService.create (match-operations).
 */
@Entity("Card")
...
export class Card {
  ...
  /** Temps de jeu (1ère/2e mi-temps, prolongations) — renseigné par l'app match-operations. */
