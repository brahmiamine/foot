 ...
 * (refund_id chez payments, voir TASK-P0-001). Même entité/pattern que
 * ticketing/src/entities/StockUnavailableRefund.ts, traité par
...
export class StockUnavailableRefund {
  ...
  // pas tranché (voir payments POST /refunds/:id/{confirm,reject}).
