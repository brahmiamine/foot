  ...
  const allMenuGroups: MenuGroup[] = useMemo(
    () => [
      ...
      },
      {
        ...
        items: [
          { title: "Dossier fédéral", icon: "fas fa-file-shield", href: "/admin/federation/compliance", children: [{ title: "Conformité", href: "/admin/federation/compliance" }] },
