 ...
 * l'abonnement Web Push du compte connecté (staff arbinote — alertes de
 * vote, anomalies) : arbinote ne signe jamais de requête en son nom, il
 ...
 * de boîte de réception dans arbinote.
 */
