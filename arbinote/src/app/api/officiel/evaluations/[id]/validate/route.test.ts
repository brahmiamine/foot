...
function postRequest(evaluationId: string): NextRequest {
  return new NextRequest(`http://localhost/api/officiel/evaluations/${evaluationId}/validate`, { method: 'POST' })
}
...
describe('POST /api/officiel/evaluations/:id/validate — homologation dérivée de la fédération du match (migration.md §9/§12)', () => {
