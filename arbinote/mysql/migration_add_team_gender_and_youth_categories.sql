...
-- (homme / femme / mixte).
--
-- Table PARTAGÉE avec ArbiNote, SuperAdmin (référentiel) et match-operations
...
-- (ArbiNote, SuperAdmin, match-operations) lisent/écrivent cette même colonne.
...
-- l'app club-hub ne consomme pas encore ces tables (elle ne lit que
