 ...
 * pour un appel serveur-à-serveur — ticketing relaie le jeton du membre
 * avant d'initier un paiement Paymee (voir ticketing/src/lib/ssoProfileClient.ts),
 * même convention que notifications pour les apps clientes.
 */
...
export async function PATCH(request: NextRequest) {
  ...
  // serveur, ex. ticketing/ob) n'est jamais rejouable par un navigateur
