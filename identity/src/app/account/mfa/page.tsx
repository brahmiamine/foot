    ...
    <div className="sso-page">
      <div className="sso-card">
        ...
        <p className="sso-muted">
          Protège votre compte SUPERADMIN avec une application d&apos;authentification (Google
          Authenticator, Authy…) en plus de votre mot de passe.
        </p>
        <MfaSetupForm initialEnabled={mfaEnabled} />
      </div>
      <style>{`
        .sso-page {
          min-height: 100vh;
