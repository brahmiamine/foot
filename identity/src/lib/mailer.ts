...
/**
 * Repris du pattern déjà utilisé dans seller-portal (src/lib/mailer.ts) :
 * dégrade proprement (log + pas d'erreur) si SMTP n'est pas configuré,
 * plutôt que de faire planter le flux appelant (ex. mot de passe oublié)
 * en environnement de dev sans SMTP.
 */
