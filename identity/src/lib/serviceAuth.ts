 ...
 * utilisateur. TS-53/TS-54 (avancement.md, Epic E17) : `federation-hub`
 ...
 * même pattern que `match-operations/src/lib/serviceAuth.ts`
 * (`MATCH_OPERATIONS_SERVICE_API_KEY`) et `x-api-key` côté marketplace/
 * notifications.
 */
