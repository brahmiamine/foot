 ...
 * payment-api (Konnect/Paymee/remboursement partiel n'ont pas de webhook
 * de remboursement, voir payment-api/README.md § Remboursements) : sans
 ...
 * payment-api. Même pattern que CheckoutReconciliationService — la
