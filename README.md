...
| [`superadmin`](./superadmin) | Back-office interne : référentiels fédérations/ligues/saisons/journées/équipes/matchs/arbitres, journal d'audit, gestion des comptes club. | 3002 | `SUPERADMIN` via SSO |
