...
const CACHE_NAME = 'matchsheet-v1';
const urlsToCache = [
  '/',
  '/manifest.json',
];
...
// Les requêtes /api/ (composition, événements live, signatures) ne sont
// jamais mises en cache : la feuille de match doit toujours refléter
// l'état serveur le plus récent, pas une réponse périmée.
