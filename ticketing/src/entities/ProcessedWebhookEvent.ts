...
/**
 * Journal des `eventId` de webhook payments déjà traités (TS-14,
 * avancement.md) — payments retente la livraison en cas d'échec réseau
 * (voir payments/src/webhooks/webhook-dispatch.service.ts), le même
