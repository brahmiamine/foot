 ...
 * paiement PAID (voir payments/src/webhooks). Le corps n'est jamais
 ...
 * relit GET /payments/:id auprès de payments avant de marquer les
 * billets PAID (même pattern que le retour payeur / "mes billets"). Sans
 * PAYMENT_WEBHOOK_SECRET configuré, la route répond 401 : ticketing
 * continue alors de se fier uniquement à sa reconciliation par polling
 * existante.
 *
 * TS-14 (avancement.md) : payments retente la livraison en cas d'échec
